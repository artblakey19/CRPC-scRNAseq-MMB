...
DimPlot(HGF_MET1, reduction = "umap", pt.size = 0.3, cols = c(
    "chartreuse3", "salmon", "lightgrey", "lightgrey", "lightgrey", "lightgrey",
...
HGF_MET1.epi1 <- RenameIdents(
    object = HGF_MET1.epi1, "0" = "BE", "5" = "LE1", "4" = "LE2", "3" = "LE3", "11" = "LE4",
...
DotPlot(HGF_MET1.epi1, features = c(
    "hMETtg", "hHGFtg", "Krt14", "Krt17", "Lgals7", "Krt5", "Col17a1",
...
HGF_MET1.LE.all.markers.Top50 <- HGF_MET1.LE.all.markers %>%
    group_by(cluster) %>%
...
FeaturePlot(TriplevDouble.combined1, reduction = "umap", features = c(
    "Krt5", "Krt4", "Krt8", "Cd24a", "Plp1",
    "Fbln1", "Myh11", "Pecam1",
    "Vim", "Tyrobp", "Ccl5", "Pate4"
), cols = c("light grey", "red"), pt.size = 0.3, max.cutoff = "q90")
...
TriplevDouble.combined1 <- RenameIdents(
    object = TriplevDouble.combined1,
    "1" = "BE", "3" = "BE", "20" = "BE",
...
DotPlot(TriplevDouble.combined1, features = c(
...
# Rename Clusters
Idents(object = TriplevDouble.combined1.epi2) <- "seurat_clusters"
TriplevDouble.combined1.epi2 <- RenameIdents(
    object = TriplevDouble.combined1.epi2,
    "33" = "BE1",
    "6" = "BE2", "16" = "BE2", "29" = "BE2",
    "15" = "BE3", "5" = "BE3",
...
DimPlot(TriplevDouble.combined1.epi2,
    reduction = "umap", pt.size = 0.3, label.size = 6,
    cols = c(
        "salmon", "skyblue1", "olivedrab2", "brown3", "deeppink1", "blue", "darkorange", "red", "turquoise3",
...
DimPlot(TriplevDouble.combined1.epi2,
    reduction = "umap", pt.size = 0.3, label.size = 6, split.by = "stim",
    cols = c(
        "salmon", "skyblue1", "olivedrab2", "brown3", "deeppink1", "blue", "darkorange", "red", "turquoise3",
        "bisque3", "slategray3", "mediumorchid3",
        "yellow2", "green4", "black"
...
DotPlot(TriplevDouble.combined1.epi2, features = c(
...
TriplevDouble.combined1.BELEMETPos <- subset(TriplevDouble.combined1.epi2METPos, idents = c(
    "BE1", "BE2", "BE3", "BE4",
    "LE1", "LE2", "LE3", "LE4",
    "LE5", "LE6", "LE7", "LE8", "LE9"
))
...
hMETtgPos_BELE_TriplevDouble.0.Markers <- FindMarkers(TriplevDouble.combined1.BELEMETPos,
    ident.1 = c("Triple"),
...
Epi_df_selected <- cbind(
    Epi_df$Pbsn, Epi_df$`Nkx3-1`, Epi_df$Fkbp5, Epi_df$Azgp1,
...
colnames(Epi_df_selected) <- c(
    "Pbsn", "Nkx3-1", "Fkbp5", "Azgp1",
...
plt + scale_color_manual(values = c(
    "salmon", "skyblue1", "olivedrab2", "brown3", "deeppink1", "blue", "darkorange", "red", "turquoise3",
    "bisque3", "slategray3", "mediumorchid3",
    "yellow2", "green4", "black"
))
...
# Fig.4h
Solid_genes <- c("Pbsn")
Solid_lineage_cds <- cds[
    rowData(cds)$gene_short_name %in% Solid_genes,
...
plot_genes_in_pseudotime(Solid_lineage_cds,
    cell_size = 1.5,
    color_cells_by = "EpiCellTypes"
