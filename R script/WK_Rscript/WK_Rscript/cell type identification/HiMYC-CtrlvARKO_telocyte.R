...
setwd("//isi-dcnl/user_data/zjsun/group/DO NOT USE-Lab Members/Won Kyung Kim/Cell Type Identification/Telocytes")


#higher resolution
DefaultAssay(CtrlvARKO.combined.FBSM1) <- "integrated"
#Run the standard workflow for visualization and clustering
CtrlvARKO.combined.FBSM1 <- ScaleData(CtrlvARKO.combined.FBSM1, verbose = FALSE)
CtrlvARKO.combined.FBSM1 <- RunPCA(CtrlvARKO.combined.FBSM1, npcs = 30, verbose = FALSE)
ElbowPlot(CtrlvARKO.combined.FBSM1, ndims = 50)
#Umap and Clustering
DefaultAssay(CtrlvARKO.combined.FBSM1) <- "integrated"
CtrlvARKO.combined.FBSM1 <- FindNeighbors(CtrlvARKO.combined.FBSM1, reduction = "pca", dims = 1:15)
CtrlvARKO.combined.FBSM1 <- FindClusters(CtrlvARKO.combined.FBSM1, resolution = 3.5)
CtrlvARKO.combined.FBSM1 <- RunUMAP(CtrlvARKO.combined.FBSM1, reduction = "pca", dims = 1:15)

Idents(object = CtrlvARKO.combined.FBSM1) <- "seurat_clusters"
DimPlot(CtrlvARKO.combined.FBSM1, reduction = "umap", label = TRUE)
DimPlot(CtrlvARKO.combined.FBSM1, reduction = "umap", split.by="stim", label = TRUE)

#Rename
Idents(object = CtrlvARKO.combined.FBSM1) <- "seurat_clusters"
CtrlvARKO.combined.FBSM1 <- RenameIdents(object = CtrlvARKO.combined.FBSM1, 
                                         '15' = "Telocyte", 
                                         '12' = "FB1", '3' = "FB1",'11' = "FB1",
                                         '9'="FB2", '29'="FB2", '7'="FB2", '23'="FB2",'28'="FB2",'11'="FB2",'8'="FB2",
                                         '6'="FB3", '0'="FB3",'18'="FB3",'1'="FB3",
                                         '2'="FB4", '13'="FB4", '16'="FB4", '22'="FB4", '16'="FB4", '21'="FB4", '25'="FB4",'10'="FB4", '31'="FB4",  
                                         '5'="FB5", '24'="FB5",'14'="FB5", '4'="FB5", '12'="SM", '15'="SM")
CtrlvARKO.combined.FBSM1[["FBSMCellTypes1"]] <- Idents(object = CtrlvARKO.combined.FBSM1)

Idents(object = CtrlvARKO.combined.FBSM1) <- "FBSMCellTypes1"
tiff(file = "CtrlvARKO.combined.FBSM1 FBSMCellTypes1 UMAP.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
DimPlot(CtrlvARKO.combined.FBSM1, reduction = "umap")
dev.off() 

Idents(object = CtrlvARKO.combined.FBSM1) <- "FBSMCellTypes1"
tiff(file = "CtrlvARKO.combined.FBSM1 FBSMCellTypes1 UMAP.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
DimPlot(CtrlvARKO.combined.FBSM1, reduction = "umap", cols = c("red","blue","darkorange","skyblue1", "bisque3","palevioletred3",
                                                               "green4"))
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 FBSMCellTypes1 split UMAP.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
DimPlot(CtrlvARKO.combined.FBSM1, reduction = "umap", split.by="stim", cols = c("red","blue","darkorange","lightblue", "bisque3","palevioletred3",
                                                                                "green4"))
dev.off()
...
tiff(file = "CtrlvARKO.combined.FBSM1 PDGFRa.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Pdgfra"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Cd34.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Cd34"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q99")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Foxl1.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Foxl1"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Epha3.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Epha3"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Spon1.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Spon1"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Foxf1.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Foxf1"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
...
DefaultAssay(ARKO.combined.FBSM1) <- "RNA"
tiff(file = "ARKO.combined.FBSM1 PDGFRa.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(ARKO.combined.FBSM1, reduction = "umap", features = c("Pdgfra"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "ARKO.combined.FBSM1 Cd34.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(ARKO.combined.FBSM1, reduction = "umap", features = c("Cd34"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q99")
dev.off()
tiff(file = "ARKO.combined.FBSM1 Foxl1.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(ARKO.combined.FBSM1, reduction = "umap", features = c("Foxl1"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q99")
dev.off()
tiff(file = "ARKO.combined.FBSM1 Ar.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(ARKO.combined.FBSM1, reduction = "umap", features = c("Ar"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "ARKO.combined.FBSM1 Gli1.tiff", width = 6.5, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(ARKO.combined.FBSM1, reduction = "umap", features = c("Gli1"), cols = c("light grey", "red"), pt.size = 1, max.cutoff = "q80")
dev.off()

#Split
DefaultAssay(CtrlvARKO.combined.FBSM1) <- "RNA"
tiff(file = "CtrlvARKO.combined.FBSM1 PDGFRa split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Pdgfra"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Cd34 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Cd34"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q99")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Foxl1 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Foxl1"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q70")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Epha3 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Epha3"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Spon1 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Spon1"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Foxf1 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Foxf1"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 EGFP split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("EGFP"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, min.cutoff = 1.5, max.cutoff = "q90")
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 Ar split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
FeaturePlot(CtrlvARKO.combined.FBSM1, reduction = "umap", features = c("Ar"), cols = c("light grey", "red"), split.by = "stim", pt.size = 1, max.cutoff = "q90")
dev.off()

##Vlnplot
#Integrated
DefaultAssay(CtrlvARKO.combined.FBSM1) <- "RNA"
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Pdgfra.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Pdgfra", pt.size = 0)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Cd34.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Cd34", pt.size = 0)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Foxf1.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Foxf1", pt.size = 0)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Foxl1.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Foxl1", pt.size = 0)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Spon1.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Spon1", pt.size = 0)
dev.off()

#split
DefaultAssay(CtrlvARKO.combined.FBSM1) <- "RNA"
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Pdgfra split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Pdgfra", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Cd34 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Cd34", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Foxf1 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Foxf1", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Foxl1 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Foxl1", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Spon1 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Spon1", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBSM1 vlnplot Epha3 split.tiff", width = 12, height = 6, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBSM1, features = "Epha3", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
...
CtrlvARKO.combined.FBSM1 <- RenameIdents(object = CtrlvARKO.combined.FBSM1, 
                                         '7' = "SM", '0' = "FB",'1' = "FB",'2' = "FB",
                                         '3' = "FB",'4' = "FB",'5' = "FB",'6' = "FB",
                                         '8' = "FB",'9' = "FB",'10' = "FB",'11' = "FB",
                                         '12' = "FB",'13' = "FB",'14' = "FB",'16' = "FB", '15' = "Telocyte")
CtrlvARKO.combined.FBSM1[["FBvTC"]] <- Idents(object = CtrlvARKO.combined.FBSM1)
DimPlot(CtrlvARKO.combined.FBSM1, reduction = "umap")
CtrlvARKO.combined.FBvTC <- subset(CtrlvARKO.combined.FBSM1, idents = c("FB", "Telocyte"))

DefaultAssay(CtrlvARKO.combined.FBvTC) <- "RNA"
Idents(object = CtrlvARKO.combined.FBvTC) <- "FBvTC"
tiff(file = "CtrlvARKO.combined.FBvTC vlnplot EGFP split.tiff", width = 6, height = 4, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBvTC, features = "EGFP", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBvTC vlnplot Foxl1 split.tiff", width = 6, height = 4, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBvTC, features = "Foxl1", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBvTC vlnplot Pdgfra split.tiff", width = 6, height = 4, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBvTC, features = "Pdgfra", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBvTC vlnplot Gli1 split.tiff", width = 6, height = 4, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBvTC, features = "Gli1", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()
tiff(file = "CtrlvARKO.combined.FBvTC vlnplot CD34 split.tiff", width = 6, height = 4, units = "in", compression = "lzw", res = 800)
VlnPlot(CtrlvARKO.combined.FBvTC, features = "Cd34", pt.size = 0, split.by = "stim", split.plot = TRUE)
dev.off()

#Cell counts
Idents(object = CtrlvARKO.combined.FBvTC) <- "FBvTC"
CtrlvARKO.combined.FBvTC$stim.FBvTC<- paste(Idents(CtrlvARKO.combined.FBvTC), CtrlvARKO.combined.FBvTC$stim, sep = "_")
Idents(object = CtrlvARKO.combined.FBvTC) <- "stim.FBvTC"
table(Idents(CtrlvARKO.combined.FBvTC))

CtrlvARKO.combined.FBvTC <- RenameIdents(object = CtrlvARKO.combined.FBvTC, 
                                         'FB_Ctrl' = "FB_Ctrl", 'FB_ARKO' = "FB_ARKO",'Telocyte_Ctrl' = "Telocyte_Ctrl",'Telocyte_ARKO' = "Telocyte_ARKO")
CtrlvARKO.combined.FBvTC[["stim.FBvTC"]] <- Idents(object = CtrlvARKO.combined.FBvTC)

#Boxplot Generation
boxdata = FetchData(CtrlvARKO.combined.FBvTC, c("stim.FBvTC", "EGFP", "Foxl1", "Pdgfra", "Gli1", "Cd34"))
tail(boxdata,6)
ggplot(boxdata, aes(x=stim.FBvTC, y=EGFP, fill = stim.FBvTC)) + geom_boxplot(outlier.color = NA)  + geom_jitter(size = 0.25) + stat_summary(fun.y = median, geom='point', size = 15, colour = "red", shape = 95)
ggplot(boxdata, aes(x=stim.FBvTC, y=Foxl1, fill = stim.FBvTC)) + geom_boxplot(outlier.color = NA)  + geom_jitter(size = 0.25) + stat_summary(fun.y = median, geom='point', size = 15, colour = "red", shape = 95)


#Cell counts
Idents(object = CtrlvARKO.combined.FBSM1) <- "FBSMCellTypes"
CtrlvARKO.combined.FBSM1$stim.FBSMCellTypes <- paste(Idents(CtrlvARKO.combined.FBSM1), CtrlvARKO.combined.FBSM1$stim, sep = "_")
Idents(object = CtrlvARKO.combined.FBSM1) <- "stim.FBSMCellTypes"
table(Idents(CtrlvARKO.combined.FBSM1))

#DEGs
Idents(object = CtrlvARKO.combined.FBSM1) <- "FBSMCellTypes"
DefaultAssay(CtrlvARKO.combined.FBSM1) <- "RNA"
all.genes <- rownames(CtrlvARKO.combined.FBSM1)
CtrlvARKO.combined.FBSM1 <- ScaleData(CtrlvARKO.combined.FBSM1, features = all.genes)
CtrlvARKO.combined.FBSM1.FBSMCellTypes.markers <- FindAllMarkers(CtrlvARKO.combined.FBSM1, min.pct = 0.1, only.pos = TRUE, logfc.threshold = 0.25)
write.csv(CtrlvARKO.combined.FBSM1.FBSMCellTypes.markers, file = "CtrlvARKO.combined.FBSM1.FBSMCellTypes.markers.csv")
