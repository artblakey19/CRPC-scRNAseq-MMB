...
setwd("W:/ARKO-Gli1_3timepoint_scRNAseq_WK/P42/Combined_CtrlvARKO/All")


Idents(object = P42_CtrlvARKO.combined) <- "seurat_clusters"
DefaultAssay(P42_CtrlvARKO.combined) <- "RNA"

tiff(file = "P42_CtrlvARKO.combined UMAP.tiff", width = 6, height = 6, units = "in", compression = "lzw", res = 800)
DimPlot(P42_CtrlvARKO.combined, reduction = "umap", pt.size = 0.3, label = TRUE)
dev.off()

tiff(file = "P42_CtrlvARKO.combined Fbln1 Exp.tiff", width = 4, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined, reduction = "umap", features = c("Fbln1"), cols = c("light grey", "red"), min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined Myh11 Exp.tiff", width = 4, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined, reduction = "umap", features = c("Myh11"), cols = c("light grey", "red"), min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined Mki67 Exp.tiff", width = 4, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined, reduction = "umap", features = c("Mki67"), cols = c("light grey", "red"), min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined Gli1 Exp.tiff", width = 4, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined, reduction = "umap", features = c("Gli1"), cols = c("light grey", "red"), min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined Ar Exp.tiff", width = 4, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined, reduction = "umap", features = c("Ar"), cols = c("light grey", "red"), min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined EGFP Exp.tiff", width = 4, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined, reduction = "umap", features = c("EGFP"), cols = c("light grey", "red"), min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()

#### P42 FBSM ####
#Subcluster FBSM
Idents(object = P42_CtrlvARKO.combined) <- "CellTypes"
P42_CtrlvARKO.combined_FBSM <- subset(P42_CtrlvARKO.combined, idents = c("Fibroblast", "SM"))
Idents(object = P42_CtrlvARKO.combined_FBSM) <- "seurat_clusters"
DimPlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", pt.size = 0.3, label = TRUE)

#Reclustering FibSM
Idents(object = P42_CtrlvARKO.combined_FBSM) <- "seurat_clusters"
DefaultAssay(P42_CtrlvARKO.combined_FBSM) <- "integrated"
P42_CtrlvARKO.combined_FBSM <- ScaleData(P42_CtrlvARKO.combined_FBSM, verbose = FALSE)
P42_CtrlvARKO.combined_FBSM <- RunPCA(P42_CtrlvARKO.combined_FBSM, npcs = 50, verbose = FALSE)
ElbowPlot(P42_CtrlvARKO.combined_FBSM, ndims = 50)

P42_CtrlvARKO.combined_FBSM <- FindNeighbors(P42_CtrlvARKO.combined_FBSM, reduction = "pca", dims = 1:23)
P42_CtrlvARKO.combined_FBSM <- FindClusters(P42_CtrlvARKO.combined_FBSM, resolution = 0.5)
P42_CtrlvARKO.combined_FBSM <- RunUMAP(P42_CtrlvARKO.combined_FBSM, reduction = "pca", dims = 1:23)
P42_CtrlvARKO.combined_FBSM <- RunTSNE(P42_CtrlvARKO.combined_FBSM, reduction = "pca", dims = 1:23)
DimPlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", pt.size = 0.3, label = TRUE)

tiff(file = "P42_CtrlvARKO.combined_FBSM UMAP.tiff", width = 6, height = 6, units = "in", compression = "lzw", res = 800)
DimPlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", pt.size = 0.3, label = TRUE)
dev.off()
tiff(file = "P42_CtrlvARKO.combined_FBSM stim UMAP.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
DimPlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", split.by = "stim", pt.size = 0.3, label = TRUE)
dev.off()

DefaultAssay(P42_CtrlvARKO.combined_FBSM) <- "RNA"
tiff(file = "P42_CtrlvARKO.combined_FBSM stim EGFP Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", features = c("EGFP"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined_FBSM stim Ar Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", features = c("Ar"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined_FBSM stim Gli1 Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", features = c("Gli1"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined_FBSM stim Ptch1 Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", features = c("Ptch1"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()

tiff(file = "P42_CtrlvARKO.combined_FBSM stim Aldh1a3 Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", features = c("Aldh1a3"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined_FBSM stim Esr1 Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_FBSM, reduction = "umap", features = c("Esr1"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
...
P42_CtrlvARKO.combined_EGFP_FibSM <- FindNeighbors(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "pca", dims = 1:15)
P42_CtrlvARKO.combined_EGFP_FibSM <- FindClusters(P42_CtrlvARKO.combined_EGFP_FibSM, resolution = 0.5)
P42_CtrlvARKO.combined_EGFP_FibSM <- RunUMAP(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "pca", dims = 1:15)
P42_CtrlvARKO.combined_EGFP_FibSM <- RunTSNE(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "pca", dims = 1:15)
...
tiff(file = "P42_CtrlvARKO.combined_EGFP_FibSM stim split UMAP.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
DimPlot(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "umap", split.by = "stim", pt.size = 0.3, label = TRUE)
dev.off()

Idents(object = P42_CtrlvARKO.combined_EGFP_FibSM) <- "seurat_clusters"
tiff(file = "P42_CtrlvARKO.combined_EGFP_FibSM Arstim UMAP.tiff", width = 12, height = 4, units = "in", compression = "lzw", res = 800)
...
tiff(file = "P42_CtrlvARKO.combined_EGFP_FibSM Ar stim Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "umap", features = c("Ar"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined_EGFP_FibSM Esr1 stim Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "umap", features = c("Esr1"), cols = c("light grey", "red"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
tiff(file = "P42_CtrlvARKO.combined_EGFP_FibSM Aldh1a3 stim Exp.tiff", width = 8, height = 4, units = "in", compression = "lzw", res = 800)
FeaturePlot(P42_CtrlvARKO.combined_EGFP_FibSM, reduction = "umap", features = c("Aldh1a3"), cols = c("light grey", "blue"), split.by = "stim", min.cutoff = 0, pt.size = 0.3, max.cutoff = "q90")
dev.off()
