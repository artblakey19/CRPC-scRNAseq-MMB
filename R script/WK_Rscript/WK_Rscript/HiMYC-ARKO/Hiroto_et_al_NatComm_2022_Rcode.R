...
CtrlvARKO.combined.MYCBE.0.Markers <- FindMarkers(CtrlvARKO.combined.MYCBE, ident.1 = "Ctrl", ident.2 = "ARKO", min.pct = 0, logfc.threshold = 0)
write.csv(CtrlvARKO.combined.MYCBE.0.Markers, "CtrlvARKO.combined.MYCBE.0.Markers.csv")
#p.adjust
DEG_HiMYCvARKO_hMYCtgPosBE <- read.csv("CtrlvARKO.combined.MYCBE.0.Markers.csv") 
DEG_HiMYCvARKO_hMYCtgPosBE_pvalue <- DEG_HiMYCvARKO_hMYCtgPosBE$p_val
DEG_HiMYCvARKO_hMYCtgPosBE_pvalue=as.numeric(DEG_HiMYCvARKO_hMYCtgPosBE_pvalue)
DEG_HiMYCvARKO_hMYCtgPosBE_BH = p.adjust(DEG_HiMYCvARKO_hMYCtgPosBE_pvalue, "BH")
write.csv(DEG_HiMYCvARKO_hMYCtgPosBE_BH, "DEG_HiMYCvARKO_hMYCtgPosBE_BH.csv")
#Boxplot Generation
...
ggcorr(t(expr_GOI), method = c("pairwise", "spearman"), label = TRUE)
#DEGs_hMYCtg+BE vs hMYCtg+LE in HiMYC
Idents(object = CtrlvARKO.combined.Epi1) <- "MYCExp"
CtrlvARKO.combined.Epi1$MYCExp.Epicelltype <- paste(Idents(CtrlvARKO.combined.Epi1), CtrlvARKO.combined.Epi1$Epicelltype, sep = "_")
Idents(object = CtrlvARKO.combined.Epi1) <- "MYCExp.Epicelltype"
CtrlvARKO.combined.Epi1$stim.MYCExp.Epicelltype <- paste(Idents(CtrlvARKO.combined.Epi1), CtrlvARKO.combined.Epi1$stim, sep = "_")
DefaultAssay(CtrlvARKO.combined.Epi1) <- "RNA"
Idents(object = CtrlvARKO.combined.Epi1) <- "stim.MYCExp.Epicelltype"
CtrlvARKO.combined.Epi1 <- ScaleData(CtrlvARKO.combined.Epi1, features = rownames(CtrlvARKO.combined.Epi1))
Ctrl.combined.MYCBEvLE.0.Markers <- FindMarkers(CtrlvARKO.combined.Epi1, ident.1 = c("MYCPos_BE1_Ctrl", "MYCPos_BE2_Ctrl", "MYCPos_BE3_Ctrl"), 
                                                ident.2 = c("MYCPos_LE1_Ctrl", "MYCPos_LE2_Ctrl", "MYCPos_LE3_Ctrl",
                                                            "MYCPos_LE4_Ctrl", "MYCPos_LE5_Ctrl", "MYCPos_LE6_Ctrl"), min.pct = 0, logfc.threshold = 0)
write.csv(Ctrl.combined.MYCBEvLE.0.Markers, "Ctrl.combined.MYCBEvLE.0.Markers.csv")
#p.adjust
DEG_Ctrl.combined.MYCBEvLE <- read.csv("Ctrl.combined.MYCBEvLE.0.Markers.csv") 
DEG_Ctrl.combined.MYCBEvLE_pvalue <- DEG_Ctrl.combined.MYCBEvLE$p_val
DEG_Ctrl.combined.MYCBEvLE_pvalue=as.numeric(DEG_Ctrl.combined.MYCBEvLE_pvalue)
DEG_Ctrl.combined.MYCBEvLE_BH = p.adjust(DEG_Ctrl.combined.MYCBEvLE_pvalue, "BH")
write.csv(DEG_Ctrl.combined.MYCBEvLE_BH, "DEG_Ctrl.combined.MYCBEvLE_BH.csv")
#DEGs_hMYCtg+BE vs hMYCtg+LE in ARKO
DefaultAssay(CtrlvARKO.combined.Epi1) <- "RNA"
Idents(object = CtrlvARKO.combined.Epi1) <- "stim.MYCExp.Epicelltype"
CtrlvARKO.combined.Epi1 <- ScaleData(CtrlvARKO.combined.Epi1, features = rownames(CtrlvARKO.combined.Epi1))
ARKO.combined.MYCBEvLE.0.Markers <- FindMarkers(CtrlvARKO.combined.Epi1, ident.1 = c("MYCPos_BE1_ARKO", "MYCPos_BE2_ARKO", "MYCPos_BE3_ARKO"), 
                                                ident.2 = c("MYCPos_LE1_ARKO", "MYCPos_LE2_ARKO", "MYCPos_LE3_ARKO",
                                                            "MYCPos_LE4_ARKO", "MYCPos_LE5_ARKO", "MYCPos_LE6_ARKO"), min.pct = 0, logfc.threshold = 0)
write.csv(ARKO.combined.MYCBEvLE.0.Markers, "ARKO.combined.MYCBEvLE.0.Markers.csv")
#p.adjust
DEG_ARKO.combined.MYCBEvLE <- read.csv("ARKO.combined.MYCBEvLE.0.Markers.csv") 
DEG_ARKO.combined.MYCBEvLE_pvalue <- DEG_ARKO.combined.MYCBEvLE$p_val
DEG_ARKO.combined.MYCBEvLE_pvalue=as.numeric(DEG_ARKO.combined.MYCBEvLE_pvalue)
DEG_ARKO.combined.MYCBEvLE_BH = p.adjust(DEG_ARKO.combined.MYCBEvLE_pvalue, "BH")
write.csv(DEG_ARKO.combined.MYCBEvLE_BH, "DEG_ARKO.combined.MYCBEvLE_BH.csv")
...
#DEGs_mGFP+FB in ctrl vs mGFP+FB in ARKO
...
combined.FB.EGFP.0.Markers <- FindMarkers(combined.FB.EGFP, ident.1 = "Ctrl", ident.2 = "ARKO", min.pct = 0, logfc.threshold = 0)
write.csv(combined.FB.EGFP.0.Markers, "combined.FB.EGFP.0.Markers.csv")
#p.adjust
DEG_HiMYCvARKO_EGFPPosFB <- read.csv("combined.FB.EGFP.0.Markers.csv") 
DEG_HiMYCvARKO_EGFPPosFB_pvalue <- DEG_HiMYCvARKO_EGFPPosFB$p_val
DEG_HiMYCvARKO_EGFPPosFB_pvalue=as.numeric(DEG_HiMYCvARKO_EGFPPosFB_pvalue)
DEG_HiMYCvARKO_EGFPPosFB_BH = p.adjust(DEG_HiMYCvARKO_EGFPPosFB_pvalue, "BH")
write.csv(DEG_HiMYCvARKO_EGFPPosFB_BH, "DEG_HiMYCvARKO_EGFPPosFB_BH.csv")
#Violinplot
DefaultAssay(combined.FB.EGFP) <- "RNA"
...
#DEGs_FB1vsotherFBs in Ctrl
DefaultAssay(Ctrl.combined.FB) <- "RNA"
Idents(object = Ctrl.combined.FB) <- "Strocelltype"
Ctrl.combined.FB <- ScaleData(Ctrl.combined.FB, features = rownames(Ctrl.combined.FB))
Ctrl.combined.FB.0.Markers <- FindMarkers(Ctrl.combined.FB, ident.1 = "FB1", ident.2 = c("FB2", "FB3", "FB4", "FB5"), min.pct = 0, logfc.threshold = 0)
write.csv(Ctrl.combined.FB.0.Markers, "Ctrl.combined.FB.0.Markers.csv")
#p.adjust
DEG_Ctrl.combined.FB <- read.csv("Ctrl.combined.FB.0.Markers.csv") 
DEG_Ctrl.combined.FB_pvalue <- DEG_Ctrl.combined.FB$p_val
DEG_Ctrl.combined.FB_pvalue=as.numeric(DEG_Ctrl.combined.FB_pvalue)
DEG_Ctrl.combined.FB_BH = p.adjust(DEG_Ctrl.combined.FB_pvalue, "BH")
write.csv(DEG_Ctrl.combined.FB_BH, "DEG_Ctrl.combined.FB_BH.csv")
...
CtrlvARKO.combined.FB1 <- ScaleData(CtrlvARKO.combined.FB1, features = rownames(CtrlvARKO.combined.FB1))
CtrlvARKO.combined.FB1.0.Markers <- FindMarkers(CtrlvARKO.combined.FB1, ident.1 = "Ctrl", ident.2 = "ARKO", min.pct = 0, logfc.threshold = 0)
write.csv(CtrlvARKO.combined.FB1.0.Markers, "CtrlvARKO.combined.FB1.0.Markers.csv")
#p.adjust
DEG_EGFPPosArPosFB1vEGFPPosArNegFB1 <- read.csv("CtrlvARKO.combined.FB1.0.Markers.csv") 
DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_pvalue <- DEG_EGFPPosArPosFB1vEGFPPosArNegFB1$p_val
DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_pvalue=as.numeric(DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_pvalue)
DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_BH = p.adjust(DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_pvalue, "BH")
write.csv(DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_BH, "DEG_EGFPPosArPosFB1vEGFPPosArNegFB1_BH.csv")
