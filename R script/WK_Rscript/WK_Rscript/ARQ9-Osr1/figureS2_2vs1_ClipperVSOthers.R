...
col_palette = c(col_clipper, 
                col_pooled, col_paired_2as1, col_paired_mis,
...
for(i in 1:nrow(grid_ls)){
  ...
  method_subset  = c( 'Clipper', 'BH-pool', 'BH-pair-2as1','BH-pair-mis',
                        'locfdr-emp','locfdr-swap')
...
pdf(file =  'lineplot_2vs1_clipperVSOthers.pdf', height = 23, width = 15.3)
p = arrangeGrob(
