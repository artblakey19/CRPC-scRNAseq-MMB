...
#Cell Cycle Regression epi
setwd("//isi-dcnl/user_data/zjsun/group/Lab Members/Won Kyung Kim/hHGFtg-hMETtg-Pb/TriplevDouble/TriplevDouble.combined1.epi1/TriplevDouble.combined1.epi2")
...
tiff(file = "TriplevDouble.combined1.BELEMETPos Yap1 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Yap1", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Wwtr1 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Wwtr1", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Tead1 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Tead1", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Tead2 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Tead2", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Tead3 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Tead3", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Tead4 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Tead4", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()

tiff(file = "TriplevDouble.combined1.BELEMETPos Ctgf Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Ctgf", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Cyr61 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Cyr61", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Birc5 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Birc5", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Ccnd1 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Ccnd1", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()

tiff(file = "TriplevDouble.combined1.BELEMETPos Fgf1 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Fgf1", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Bmp4 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Bmp4", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Cd274 Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Cd274", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
tiff(file = "TriplevDouble.combined1.BELEMETPos Axl Vln.tiff", width = 3.7, height = 4.5, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.BELEMETPos, features = "Axl", pt.size = 0, cols = c("#3399FF",   "#E06666")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 25, colour = "green2", shape = 95)
dev.off()
####hMETtgPos Monocle3####
...
tiff(file = "Triple.combined1.BELE Yap1 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Yap1", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Wwtr1 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Wwtr1", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Tead1 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Tead1", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Tead2 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Tead2", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Tead3 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Tead3", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Tead4 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Tead4", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()

tiff(file = "Triple.combined1.BELE Ctgf Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Ctgf", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Cyr61 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Cyr61", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Birc5 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Birc5", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
tiff(file = "Triple.combined1.BELE Ccnd1 Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Ccnd1", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()

tiff(file = "Triple.combined1.BELE Axl Vln.tiff", width = 3.5, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(Triple.combined1.BELE, features = "Axl", pt.size = 0, cols = c("grey",  "blue", "darkorange", "red")) + NoLegend() +
  stat_summary(fun.data=data_summary) + stat_summary(fun = mean, geom='point', size = 23, colour = "green2", shape = 95)
dev.off()
