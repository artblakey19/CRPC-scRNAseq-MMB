...
#qval
library(qvalue)
setwd("/Volumes/user_data/zjsun/group/Lab Members/Won Kyung Kim/hHGFtg-hMETtg-Pb/TriplevDouble/TriplevDouble.combined1.epi1")

#SupplementaryTable2
SupplementaryTable2_qval <- read_csv("Desktop/TripleTg Revision/SupplementaryTable2_qval.csv")
pvalues <- SupplementaryTable2_qval$pval
qobj <- qvalue_truncp(p = pvalues)
qvalues <- qobj$qvalues
write.csv(qvalues, file = "SupplementaryTable2_qval_final.csv")

#SupplementaryTable3
Supplementary_Table3_qval <- read_csv("Desktop/TripleTg Revision/SupplementaryTable3_qval.csv")
pvalues <- Supplementary_Table3_qval$pval
qobj <- qvalue_truncp(p = pvalues)
qvalues <- qobj$qvalues
write.csv(qvalues, file = "SupplementaryTable3_qval_final.csv")

#SupplementaryTable4
Supplementary_Table4_qval <- read_csv("Desktop/TripleTg Revision/SupplementaryTable4_qval.csv")
pvalues <- Supplementary_Table4_qval$pval
qobj <- qvalue_truncp(p = pvalues)
qvalues <- qobj$qvalues
write.csv(qvalues, file = "SupplementaryTable4_qval_final.csv")

#SupplementaryTable5
Supplementary_Table5_qval <- read_csv("Desktop/TripleTg Revision/SupplementaryTable5_qval.csv")
pvalues <- Supplementary_Table5_qval$pval
qobj <- qvalue_truncp(p = pvalues)
qvalues <- qobj$qvalues
write.csv(qvalues, file = "SupplementaryTable5_qval_final.csv")

#SupplementaryTable6
Supplementary_Table6_qval <- read_csv("Desktop/TripleTg Revision/SupplementaryTable5_qval.csv")
pvalues <- Supplementary_Table6_qval$pval
qobj <- qvalue_truncp(p = pvalues)
qvalues <- qobj$qvalues
write.csv(qvalues, file = "SupplementaryTable6_qval_final.csv")
