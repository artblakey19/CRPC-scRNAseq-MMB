...
FeaturePlot(TriplevDouble.combined1.BELEMETPos, reduction = "umap", features = c("Xpo1"), cols = c("light grey", "red"), pt.size = 0.5,  max.cutoff = "q90", split.by = "stim")
...
#Boxplots
boxdata = FetchData(TriplevDouble.combined1.BELEMETPos, c("stim", "Xpo1", "Ran", "Rpl12", "Rps16", "Myc", "Eif4e2", "Eif4a1"))

#w/o dots
tiff(file = "TriplevDouble.combined1.BELEMETPos hARtg Boxplot with Median.tiff", width = 6, height = 3, units = "in", compression = "lzw", res = 800)
ggplot(boxdata, aes(x=stim, y=Xpo1, fill = stim)) + geom_boxplot(outlier.color = NA) + stat_summary(fun = mean, geom='point', size = 15, colour = "red", shape = 95) + scale_fill_manual(values=c("#3399FF", "#E06666"))
dev.off()
...
TriplevDouble.combined1.epi1.LE <- RenameIdents(object = TriplevDouble.combined1.epi1.LE, 'LE1'="LE1", 'LE2'="LE2",'LE3' = "LE3",
                                        'LE4'="LE45678", 'LE5'="LE45678", 'LE6' = "LE45678", 'LE7' = "LE45678", 'LE8' = "LE45678")  
TriplevDouble.combined1.epi1.LE[["OthersvLE123"]] <- Idents(object = TriplevDouble.combined1.epi1.LE)

#Vlnplots
DefaultAssay(TriplevDouble.combined1.epi1.LE) <- "RNA"
Idents(object = TriplevDouble.combined1.epi1.LE) <- "OthersvLE123"
...
LE2v45678.0.Markers <- FindMarkers(TriplevDouble.combined1.epi1.LE, ident.1 = c("LE2"), 
                                                    ident.2 = c("LE45678"), min.pct = 0, logfc.threshold = 0)
write.csv(LE2v45678.0.Markers, "LE2v45678.0.Markers.csv")

#p.adjust
DEG_LE2v45678 <- read.csv("LE2v45678.0.Markers.csv") 
DEG_LE2v45678_pvalue <- DEG_LE2v45678$p_val
DEG_LE2v45678_pvalue=as.numeric(DEG_LE2v45678_pvalue)
DEG_LE2v45678_BH = p.adjust(DEG_LE2v45678_pvalue, "BH")
write.csv(DEG_LE2v45678_BH, "DEG_LE2v45678_BH.csv")
...
all.genes <- rownames(TriplevDouble.combined1.epi1.LE)
TriplevDouble.combined1.epi1.LE <- ScaleData(TriplevDouble.combined1.epi1.LE, features = all.genes)
LE3v45678.0.Markers <- FindMarkers(TriplevDouble.combined1.epi1.LE, ident.1 = c("LE3"), 
                                   ident.2 = c("LE45678"), min.pct = 0, logfc.threshold = 0)
write.csv(LE3v45678.0.Markers, "LE3v45678.0.Markers.csv")

#p.adjust
DEG_LE3v45678 <- read.csv("LE3v45678.0.Markers.csv") 
DEG_LE3v45678_pvalue <- DEG_LE3v45678$p_val
DEG_LE3v45678_pvalue=as.numeric(DEG_LE3v45678_pvalue)
DEG_LE3v45678_BH = p.adjust(DEG_LE3v45678_pvalue, "BH")
write.csv(DEG_LE3v45678_BH, "DEG_LE3v45678_BH.csv")
...
TriplevDouble.combined1.epi1.LE1[["OthersvLE23"]] <- Idents(object = TriplevDouble.combined1.epi1.LE1)

#Vlnplots
DefaultAssay(TriplevDouble.combined1.epi1.LE1) <- "RNA"
Idents(object = TriplevDouble.combined1.epi1.LE1) <- "OthersvLE23"

tiff(file = "TriplevDouble.combined1.epi1.LE1 Xpo1 Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Xpo1", pt.size = 0.01, cols = c("deeppink1", "blue", "red", "grey"), y.max = 1.5) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Ran Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Ran", pt.size = 0.01, cols = c("deeppink1", "blue", "red", "grey"), y.max = 3.5) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Rpl12 Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Rpl12", pt.size = 0.01, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Rps16 Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Rps16", pt.size = 0.01, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Myc Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Myc", pt.size = 0.01, cols = c("deeppink1", "blue", "red", "grey"), y.max = 3) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Eif4a1 Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Eif4a1", pt.size = 0.01, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Eif4e2 Vln.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
...
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Xpo1", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey"), y.max = 1.5) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Ran Vln-1.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Ran", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey"), y.max = 3.5) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Rpl12 Vln-1.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Rpl12", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Rps16 Vln-1.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Rps16", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Myc Vln-1.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Myc", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey"), y.max = 3) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Eif4a1 Vln-1.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Eif4a1", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
tiff(file = "TriplevDouble.combined1.epi1.LE1 Eif4e2 Vln-1.tiff", width = 4, height = 3, units = "in", compression = "lzw", res = 800)
VlnPlot(TriplevDouble.combined1.epi1.LE1, features = "Eif4e2", pt.size = 0, cols = c("deeppink1", "blue", "red", "grey")) + NoLegend()
dev.off()
...
LE2v15678.0.Markers <- FindMarkers(TriplevDouble.combined1.epi1.LE1, ident.1 = c("LE2"), 
                                  ident.2 = c("LE5678"), min.pct = 0, logfc.threshold = 0)
write.csv(LE2v15678.0.Markers, "LE2v15678.0.Markers.csv")

#p.adjust
DEG_LE2v15678 <- read.csv("LE2v15678.0.Markers.csv") 
DEG_LE2v15678_pvalue <- DEG_LE2v15678$p_val
DEG_LE2v15678_pvalue=as.numeric(DEG_LE2v15678_pvalue)
DEG_LE2v15678_BH = p.adjust(DEG_LE2v15678_pvalue, "BH")
write.csv(DEG_LE2v15678_BH, "DEG_LE2v15678_BH.csv")
...
all.genes <- rownames(TriplevDouble.combined1.epi1.LE1)
TriplevDouble.combined1.epi1.LE1 <- ScaleData(TriplevDouble.combined1.epi1.LE1, features = all.genes)
LE3v15678.0.Markers <- FindMarkers(TriplevDouble.combined1.epi1.LE1, ident.1 = c("LE3"), 
                                  ident.2 = c("LE5678"), min.pct = 0, logfc.threshold = 0)
write.csv(LE3v15678.0.Markers, "LE3v15678.0.Markers.csv")

#p.adjust
DEG_LE3v15678 <- read.csv("LE3v15678.0.Markers.csv") 
DEG_LE3v15678_pvalue <- DEG_LE3v15678$p_val
DEG_LE3v15678_pvalue=as.numeric(DEG_LE3v15678_pvalue)
DEG_LE3v15678_BH = p.adjust(DEG_LE3v15678_pvalue, "BH")
write.csv(DEG_LE3v15678_BH, "DEG_LE3v15678_BH.csv")

#Mouse to human ortholog conversion
library(babelgene)
# Must have a column named Symbol
genelist = DEG_LE2vOthers_preranked$symbol
ortho_DEG_LE2vOthers_preranked<- orthologs(genes = genelist, species = "mouse", human = F, min_support = 5, top = TRUE)

DEG_LE2vOthers_preranked <- inner_join(DEG_LE2vOthers_preranked,ortho_DEG_LE2vOthers_preranked,by = "symbol") %>% select(contains (c("symbol","logFC")))

write.table(DEG_LE2vOthers_preranked,"converted_gsea_DEG_LE2vOthers_preranked.txt")

# Must have a column named Symbol
genelist = DEG_LE3vOthers_preranked$symbol
ortho_DEG_LE3vOthers_preranked<- orthologs(genes = genelist, species = "mouse", human = F, min_support = 5, top = TRUE)

DEG_LE3vOthers_preranked <- inner_join(DEG_LE3vOthers_preranked,ortho_DEG_LE3vOthers_preranked,by = "symbol") %>% select(contains (c("symbol","logFC")))

write.table(DEG_LE3vOthers_preranked,"converted_gsea_DEG_LE3vOthers_preranked.txt")
